    ...
    <form id="tab-1"
        ...
        <div class="form-group">
            <label class="form-label"
                   for="RegistrationForm_reppassword"><? echo $lang["reg_form"]['repeat_password']; ?></label>
            <div class="input-holder">
        ...
        <div class="form-group">
            <label class="upload-label" for="RegistrationForm_photo">
                <!-- style="background: url('img/ico/gender_ico.png'); background-size: cover"-->
        ...
        <p class="user-terms"><? echo $lang["reg_form"]['license']; ?><a
                    href="#"><? echo $lang["reg_form"]['agreement']; ?></a></p>
