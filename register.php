...
$db = new MyDatabase();        //объект базы данных mydb
...
if ($validForm->isError()) {
    ...
    $arr = array('Name', 'Email', 'Password', 'Reppassword', 'Gender', 'Birth_day', 'Birth_month', 'Birth_year');
    foreach ($arr as $v) {
        $meth = "is" . $v;
